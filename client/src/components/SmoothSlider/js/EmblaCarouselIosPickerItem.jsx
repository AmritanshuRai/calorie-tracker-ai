...
export const IosPickerItem = (props) => {
  ...
  const [emblaRef, emblaApi] = useEmblaCarousel({
    ...
    containScroll: false,
    watchSlides: false,
    startIndex: value ? parseInt(value) - startValue : 0,
  });
  ...
  useEffect(() => {
    ...
    if (onChange) {
      emblaApi.on('settle', () => {
        ...
        const selectedValue = selectedIndex + startValue;
    ...
    inactivateEmblaTransform(emblaApi);
    rotateWheel(emblaApi);
  }, [emblaApi, inactivateEmblaTransform, rotateWheel, onChange, startValue]);
